@extends("master")
@section('title_area')
    :: Admin  :: চেয়ারম্যান মহোদয়ের তথ্য
@endsection
    ...
    <article class="">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
               ...
               <h2> চেয়ারম্যান মহোদয়ের তথ্য </h2>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                  <div class="row">
                  <div class="col-md-4">  <h5 class="modal-title" id="myModalLabel"> চেয়ারম্যান মহোদয়ের তথ্য </h5></div>
                ...
                <form class="form-validation" enctype="multipart/form-data" id="union_setup_form"
                    ...
                    <div class="modal-body">
                        ...
                        <label class="col-md-2 modalLabelText">Upazila <span class="text-danger">*</span></label>
                            ...
                            <label class="col-md-2 modalLabelText">Union Name </label>
                            <div class="col-md-4">
                                <input type="name" class="form-control form-control-alt" name="union_name" id="union_name"
                                       placeholder="Union Name" >
                            </div>
                        </div>
                        <h6 style="text-align: left; font-weight: bold;">Chairman Information : </h6>
                        <div class="form-group row">
...
<script>
  ...
  $(document).ready(function(){
    let unionSetupTable = $("#dc_uno_chairman_table").DataTable({
        ...
        processing: true,
        ajax: {
                url: '{{route("chairman.chairman_info")}}',
                data: function (e) {
...
function DcUnoChairmanSave(){
    ...
    if(division_id > 0 && name !=''){
        $.ajax({
                url:"{{route('chairman.chairman_store')}}",
                type:"POST",
                data:{
