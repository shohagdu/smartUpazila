    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header style="height: 45px;">
                ...
                <h2>Union Setup </h2>
                <button onclick="AddNew()"  style="float: right; margin-top:6px; margin-right: 10px;" class="btn btn-sm btn-success addNew">Add New </button>
            </header>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel"> Union Setup </h5>
                ...
                <form class="form-validation" enctype="multipart/form-data" id="union_setup_form"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 form-control-label"> Upazila Name <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 form-control-label">Union Name <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 form-control-label">Union Code <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 form-control-label"> Web url <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 form-control-label"> Status <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                    ...
                    <input type="hidden" id="union_info_id" name="union_info_id">
                        <button type="submit" onclick="unionSetupSave()" id="union_setup_save_button"
                                class="btn btn-primary btn-sm waves-effect waves-light"> <span id="SubmitbtnText"> Submit </span>
                        </button>
