        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  <div class="row">
                  <div class="col-md-4">  <h5 class="modal-title" id="myModalLabel"> Parisad Kajjaboli </h5></div>
                ...
                <form class="form-validation" enctype="multipart/form-data" id="union_setup_form"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 form-control-label modalLabelText"> Office <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                                <input class="form-control form-control-alt" id="office" name="office" required>
                                   
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="name" class="col-md-4 form-control-label modalLabelText"> Message <span class="text-danger">*</span></label>
                            <div class="col-md-7">
                            <textarea name="message" id="message" colspan="10" class="form-control"></textarea>
                            </div>
                        </div>
...
<script>
  ...
  $(document).ready(function(){
    let unionSetupTable = $("#parisad_kajjaboli_table").DataTable({
        scrollCollapse: true,
        autoWidth: false,
        responsive: true,
        serverSide: true,
        processing: true,
        ajax:"{{route('upazila_parishad.parisad_kajjoboli')}}",
        columns:[
