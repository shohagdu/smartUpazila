@extends("master")
@section('title_area')
    :: Admin  :: Female Vice Chairman add
@endsection
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2> Female  Vice Chairman Add </h2>
                <a href="{{ route('upazila_parishad.female_vice_chairman')}}" class="btn btn-xs btn-success addNew"><i class="glyphicon glyphicon-list"></i> Female Vice Chairman List </a>
            </header>
            ...
            <div >
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <form action="{{ route('upazila_parishad.female_vice_chairman_store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                             <br><br>
