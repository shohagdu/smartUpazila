    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2> Vice Chairman Add </h2>
                <a href="{{ route('upazila_parishad.vice_chairman')}}" class="btn btn-xs btn-success addNew"><i class="glyphicon glyphicon-list"></i>  Chairman List </a>
            </header>
