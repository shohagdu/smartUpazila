@extends("master")
@section('title_area')
    :: Admin  :: Educational institutions Edit
@endsection
    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2> Educational institutions Edit </h2>
                <a href="{{ route('government_institution.educational_institutions')}}" class="btn btn-xs btn-success addNew"><i class="glyphicon glyphicon-list"></i>  Educational institutions  List </a>
            </header>
            ...
            <div >
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <form action="{{ route('government_institution.educational_institutions_update', $info->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                             <br><br>
