            ...
            <div >
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <form action="{{ route('dynamic_content_page.update', $info->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                             <br><br>
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <input type="hidden" name="pre_image" id="pre_image" value="{{$info->attachment}}">
                            </div>
                           ...
                           <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                   <textarea rows="5" class="form-control" name="remarks" id="remarks"> {{$info->remarks}}</textarea>
                                </div>
                                <div class="col-md-2"></div>
                                <div class="col-md-4">

                                @if(!empty($info->attachment))
                                      <img src="{{ asset('img/dynamic_content_page')}}/{{$info->attachment}}" id="img_preview" style="width: 100%; height: 100px;"/>
                                    @else
                           ...
                           <div class="col-md-10">
                           <textarea class="form-control" id="summary-ckeditor" name="details">{{$info->details}}</textarea>
                           </div>
