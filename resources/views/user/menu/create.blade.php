            ...
            <div >
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <form action="{{ route('government_institution.non_govt_organizations_store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                             <br><br>
                            <div class="form-group row">
                                ...
                                <label for="name" class="col-md-2 form-control-label modalLabelText"> Link <span class="text-danger">*</span></label>
                                <div class="col-md-4">
                                    <input type="text" class="form-control form-control-alt" name="link" id="link" required
                                        placeholder="link">
                                </div>
                           </div>
                           <div class="form-group row">
                                <label for="name" class="col-md-1 form-control-label modalLabelText"> Menu  <span class="text-danger">*</span></label>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control form-control-alt" name="glyphicon_icon" id="glyphicon_icon" required
                                        placeholder="Glyphicon Icon ">
                                </div>
                           </div>
                           
                           <div class="form-group row">
                            <label for="name" class="col-md-1 form-control-label modalLabelText"> Position <span class="text-danger">*</span></label>
                            <div class="col-md-4">
                               <input type="text" class="form-control form-control-alt" name="display_position" id="display_position" required
