    ...
    <article class="col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="jarviswidget" id="wid-id-2" data-widget-colorbutton="false" data-widget-editbutton="false">
            <header>
                ...
                <h2> Mayor Add </h2>
                <a href="{{ route('pourosova_related.pourosova_mayor')}}" class="btn btn-xs btn-success addNew"><i class="glyphicon glyphicon-list"></i>  Mayor List </a>
            </header>
            ...
            <div >
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <form action="{{ route('pourosova_related.pourosova_mayor_store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                             <br><br>
