            ...
            <div >
                <div class="widget-body no-padding">
                    <div class="col-sm-12">
                        ...
                        <form action="{{ route('pourosova_related.pourosova_kormocari_update', $kormocari_data[0]->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                             <br><br>
                           ...
                           <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    value="{{$kormocari_data[0]->designation}}">
                                </div>   
                           </div><br>
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control form-control-alt" id="is_active" name="is_active" required>
                                    ...
                                    <option value="1" <?php if($kormocari_data[0]->is_active==1){ echo "selected";}?>> Active </option>
                                    <option value="2" <?php if($kormocari_data[0]->is_active==2){ echo "selected";}?>> Inactive </option>
                             ...
                             <label for="name" class="col-md-2 form-control-label modalLabelText"> View order <span class="text-danger">*</span></label>
                                <div class="col-md-4">
                                    ...
                                    value="{{$kormocari_data[0]->view_order}}">
                                </div>
                           ...
                           <div class="form-group row">
                                ...
                                <label for="name" class="form-control-label"> Responsibilities</label>
                                   <textarea class="form-control" name="responsibilities" id="responsibilities"> {{$kormocari_data[0]->responsibilities}}</textarea>
                                </div>
